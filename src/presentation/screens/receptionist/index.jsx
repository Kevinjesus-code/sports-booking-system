...
import VerifyReservations from "./verify-reservations/verify-reservations";
...
const INITIAL_NOTIFS = [
  {
    ...
    desc: "Juan Pérez · Fútbol 5 · 14:00 – 15:00",
    time: "Hace 5 minutos",
    unread: true,
    iconClass: "ni-green",
    icon: (
  ...
  },
  {
    ...
    desc: "María González · Fútbol 7 · 15:00 – 16:00",
  ...
  },
  {
    ...
    desc: "Luis Torres se registró en el sistema",
    time: "Hace 1 hora",
    unread: false,
    iconClass: "ni-blue",
    icon: (
  ...
  },
  {
    id: 4,
    title: "Pago recibido",
    desc: "S/ 80.00 · Cancha Fútbol 5 · Carlos Ramos",
    time: "Hace 2 horas",
    unread: false,
    iconClass: "ni-green",
    icon: (
  ...
  const renderContenido = () => {
    switch (seccionActiva) {
      case "dashboard":
        return <Dashboard />;
      case "verificar":
        return <VerifyReservations />;
      case "clientes":
        return <Customers />;
      case "reservas":
        return <Reservations onNavigate={setSeccionActiva} />;
  ...
  return (
    <div className={styles["containerRecepcionist"]}>
      ...
      <main className={styles["containerContent"]} onClick={closeAll}>
        ...
        {showNotifs && (
          <div
            className={`${styles["panel"]} ${styles["notifPanel"]}`}
          ...
          >
            ...
            <div className={styles["notifToolbar"]}>
              <div className={styles["notifTabs"]}>
                <button className={`${styles["notifTab"]} ${styles["active"]}`}>
                  Todas
                </button>
            ...
            <ul className={styles["notifList"]}>
              {notifs.map((n) => (
                ...
                >
                  <span
                    className={`${styles["notifDot"]} ${n.unread ? "" : styles["read"]}`}
                  />
          ...
          >
            ...
            <div className={styles["profileInfoList"]}>
              <div className={styles["profileInfoRow"]}>
                ...
                <div>
                  <div className={styles["profileInfoLabel"]}>
                    Nombre completo
                  </div>
              ...
              <div className={styles["profileInfoRow"]}>
                <div className={styles["profileInfoIcon"]}>
                  <svg viewBox="0 0 24 24">
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2A19.79 19.79 0 0 1 11.39 18 19.5 19.5 0 0 1 8 14.61 19.79 19.79 0 0 1 4.12 6.18 2 2 0 0 1 6.1 4h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L10.09 11a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 24 18z" />
                  </svg>
                </div>
                <div>
            ...
            <div className={styles["profileActions"]}>
              ...
              <button
                className={`${styles["profileBtn"]} ${styles["logout"]}`}
